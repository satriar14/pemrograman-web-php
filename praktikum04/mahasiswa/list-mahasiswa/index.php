...
$mahasiswa1 = new Mahasiswa(getRandomNim(), 'satria');
$mahasiswa2 = new Mahasiswa(getRandomNim(), 'Ramadhan');
$mahasiswa3 = new Mahasiswa(getRandomNim(), 'Abdul');
$mahasiswa4 = new Mahasiswa(getRandomNim(), 'Muhammad');
